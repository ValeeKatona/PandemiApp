...
describe('LoginPage', () => {
  ...
  it('given user is recovering pasword, when success, then hide loading and show success message', () => {
  ...
  it('given user is recovering pasword, when fail, then hide loading and show error message', () => {
    spyOn(toastController, 'create').and.returnValue(<any>Promise.resolve({present: () => {}}));
